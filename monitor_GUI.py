...
class Ui_iAmVM(object):
    def setupUi(self, iAmVM):
        ...
        self.block.setGeometry(QtCore.QRect(260, 190, 91, 23))
        icon1 = QtGui.QIcon()
        ...
        self.allow_once.setGeometry(QtCore.QRect(150, 190, 91, 23))
        icon2 = QtGui.QIcon()
